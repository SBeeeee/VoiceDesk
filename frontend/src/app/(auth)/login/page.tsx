...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4 relative overflow-hidden selection:bg-pink-100 selection:text-pink-600">
      {/* Ambient Background Blobs */}
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-pink-100/50 blur-[120px] rounded-full animate-pulse" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[400px] h-[400px] bg-rose-100/30 blur-[100px] rounded-full animate-pulse [animation-delay:2s]" />
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <p className="text-center text-gray-500 text-sm mt-8 animate-in fade-in slide-in-from-bottom-2 duration-1000 delay-500">
          ...
          <Link href="/signup" className="text-pink-600 font-bold hover:text-rose-600 transition-colors underline-offset-4 decoration-2">
            Create account
          </Link>
        </p>
      </div>
